...
export default function TabLayout() {
  return (
    ...
    <Tab.Navigator  screenOptions={({ route }) => ({
      ...
      {/* Home Tab */}
      <Tab.Screen name="Home" component={Home} options={{ title: 'Home' }} screenOptions={{headershown:false}}/>
      
      <Tab.Screen name="List" component={ListScreen} options={{ title: 'List Insurance' }} screenOptions={{headershown:false}} />
      {/* Profile Tab */}
      <Tab.Screen name="Profile" component={ProfileScreen} options={{ title: 'Profile' }} screenOptions={{headershown:false}} />
      ...
      />
      {/* Settings Tab */}
      <Tab.Screen name="Settings" component={SettingsScreen} options={{ title: 'Settings' }} screenOptions={{headershown:false}} />
    </Tab.Navigator>
    </>
  );
}
