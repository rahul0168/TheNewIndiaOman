...
// import SvgArrowLeft from './assets/icons/arrow-left.svg'; // Example SVG Icon

export default function DetailScreen(      ) {
  // const item = useLocalSearchParams(); // Get item from route params
  ...
  return (
    <ScrollView className="flex-1 bg-gray-100">
      ...
      <View className="flex-1 p-5">
        ...
        {/* Item Title */}
        <Text className="text-3xl font-bold text-blue-500 mb-2">{item.name}</Text>
        ...
        <View className="mt-6">
          ...
          <Text className="text-lg text-gray-700">{item.price || 'Not available'}</Text>

          <Text className="text-xl font-semibold text-gray-800 mt-4 mb-2">Location:</Text>
          <Text className="text-lg text-gray-700">{item.location || 'Not available'}</Text>
        </View>
