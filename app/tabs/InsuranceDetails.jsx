    ...
    <ScrollView contentContainerStyle="flex-1 p-4">
        ...
        {tabs.map((tab) => (
          ...
          >
            <Ionicons
              name={tab.icon}
              size={24}
              color={activeTab === tab.name ? "white" : "gray"}
            />
            <Text
              className={`ml-2 ${
      ...
      {activeTab === "coverage" && (
        <View className="bg-white shadow-md rounded p-4 mb-4">
          ...
          <Text className="font-semibold mb-2">
            Policy Expiry Date / تاريخ انتهاء الوثيقة
          </Text>
          <PTextInput
            mode="outlined"
      ...
      {currentPage === 1 && (
        <View className="bg-white shadow-md rounded p-4 mb-4">
          ...
          <Text className="font-semibold mb-2">
            License Number / أدخل رقم رخصة القيادة أو الرقم المدني
          </Text>
          <PTextInput
            mode="outlined"
          ...
          <Text className="font-semibold mb-2">
            First Registration / التسجيل الأول في السلطنة
          </Text>
          <PTextInput
            mode="outlined"
          ...
          <Text className="font-semibold mb-2">
            Is Your Vehicle Imported? / هل المركبة واردة
          </Text>
          <View className="flex-row mb-4">
            ...
            <TouchableOpacity onPress={() => setIsImported("no")}>
              <Text
                className={`px-2 py-1 ${
                  isImported === "no" ? "bg-blue-500 text-white" : "bg-gray-200"
                }`}
              >
                No
              </Text>
          ...
          {/* Finance/تمويل Input */}
          <Text className="font-semibold mb-2 mt-4">Finance/تمويل</Text>
          <PTextInput
            value={finance}
      ...
      {currentPage === 2 && (
        <View className="bg-white shadow-md rounded p-4 mb-4">
          <Text className="text-xl font-semibold mb-4">
            Tell Us About The Driver /الرجاء اخطارنا عن اي سائق
          </Text>
          ...
          <View className="flex-row mb-4">
            <TouchableOpacity
              onPress={() => setAddDriver(true)}
              className="mr-4"
            >
              <Text
                className={`px-2 py-1 ${
                  addDriver ? "bg-blue-500 text-white" : "bg-gray-200"
                }`}
              >
                Yes
              </Text>
