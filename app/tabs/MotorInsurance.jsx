...
const MotorInsurance = () => {
        ...
        return (
          <View className="bg-white p-4 rounded-lg shadow">
            <View className="flex-row items-center mb-4">
              ...
              <Text className="ml-3 text-lg font-bold text-gray-700">Vehicle Details</Text>
            </View>
            ...
            <Text className="font-semibold mb-2">License Number</Text>
                ...
                <Text className="font-semibold mb-2">Is Your Vehicle Imported? </Text>
        ...
        return (
          <View className="bg-white p-4 rounded-lg shadow">
            <View className="flex-row items-center mb-4">
              ...
              <Text className="ml-3 text-lg font-bold text-gray-700">Personal Info</Text>
            </View>
            <TextInput
        ...
        return (
          <View className="bg-white p-4 rounded-lg shadow">
            <TouchableOpacity className="flex-row items-center">
              <Ionicons name="person-add-outline" size={28} color="#0c4ea2" />
              <Text className="ml-3 text-base font-medium text-teal-800">Add Additional Driver</Text>
            </TouchableOpacity>
          </View>
        );
      default:
  ...
  return (
    <View className="flex-1 bg-gray-100 mt-4">
      {/* Tabs */}
      <Text className="text-2xl pl-2 font-bold mb-4">Motor Insurance Quote</Text>
      
      <View className="flex-row justify-around bg-white p-2 shadow rounded-full mb-4">
        {[
