    ...
    switch (activeTab) {
      case "Vehicle Details":
        ...
        return (
          ...
          >
            ...
            <View className="gap-4">
              ...
              <View className="gap-2">
                ...
                <PTextInput mode="outlined" label="Policy No" placeholder="Policy No" theme={{ colors: { primary: "#1E3A8A" } }} 
                 outlineStyle={{ borderRadius: 25 }} className="bg-white"
                value={formData.policyNo} onChangeText={(text) => handleInputChange('policyNo', text)} />
              </View>
            ...
            <PTextInput mode="outlined" label="Registration No"
              placeholder="eg:AA/1234"  theme={{ colors: { primary: "#1E3A8A" } }}  outlineStyle={{ borderRadius: 25 }} className="bg-white"
             value={formData.registrationNo} onChangeText={(text) => handleInputChange('registrationNo', text)} />
          </View>
          ...
          <View className="gap-2">
            ...
            <PTextInput mode="outlined" placeholder="Mobile Number" theme={{ colors: { primary: "#1E3A8A" } }} 
                 outlineStyle={{ borderRadius: 25 }}  className="bg-white" 
            value={formData.mobileNumber} onChangeText={(text) => handleInputChange('mobileNumber', text)} />
          </View>
          ...
          <View className="gap-2">
            ...
            <PTextInput mode="outlined" placeholder="Enter OTP" theme={{ colors: { primary: "#1E3A8A" } }} 
                 outlineStyle={{ borderRadius: 25 }} className="bg-white" 
            value={formData.otp} onChangeText={(text) => handleInputChange('otp', text)} />
          </View>
          ...
          <View className="gap-2">
            ...
            <PTextInput mode="outlined" placeholder="eg:abc@gmail.com" theme={{ colors: { primary: "#1E3A8A" } }} 
                 outlineStyle={{ borderRadius: 25 }} keyboardType="email-address" className="bg-white" 
            value={formData.email} onChangeText={(text) => handleInputChange('email', text)} />
          </View>
          ...
          <View style={styles.pickerContainer}>
                  ...
                  >
                    ...
                    <Picker.Item value="TP1" label="Third Party with PA Cover to Driver & Family members" />
                    <Picker.Item value="TPD" label="Third Party with PA Cover to driver only" />
      ...
      case "Motor Summery":
        return (
          ...
          <Text className="text-2xl font-bold text-blue-900 mb-4">Renewal Summary  </Text>
