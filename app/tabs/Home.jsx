...
const insuranceSlides = [
  {
    ...
    icon: "car",
    color: "#4299e1",
    bgImage: require("../../assets/images/motors.jpg"),
  },
  {
    title: "Car Insurance",
    URL: "",
    icon: "car",
    color: "#4299e1",
    bgImage: require("../../assets/images/motor.jpg"),
  },
  {
    ...
    icon: "heart",
    color: "#4299e1",
    bgImage: require("../../assets/images/healths.jpg"),
  },
  {
    ...
    icon: "home",
    color: "#4299e1",
    bgImage: require("../../assets/images/home.jpg"),
  },
  {
    ...
    icon: "airplane",
    color: "#4299e1",
    bgImage: require("../../assets/images/travel.jpg"),
  },
];
...
export default function HomeScreen() {
  ...
  const prevSlide = () => {
    setCurrentSlide(
      (prev) => (prev - 1 + insuranceSlides.length) % insuranceSlides.length
    );
  };
                  ...
                  >
                    ...
                    >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          navigation.navigate(item.URL, { id: index })
                        }
                      >
