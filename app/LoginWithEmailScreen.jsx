...
export default function LoginWithEmailScreen() {
  ...
  return (
    <ImageBackground
      source={{
        uri: "https://img.freepik.com/premium-photo/abstract-blue-curved-lines-background_1174990-218533.jpg",
    ...
    >
      ...
      <ScrollView className="flex-1 w-full mt-64">
        <View className="w-full bg-white p-6 rounded-tl-2xl rounded-tr-2xl shadow-lg">
          {/* Logo */}
          <Image
          ...
          <Text className="text-sm text-blue text-center mb-5">
